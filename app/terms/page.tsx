export default function Terms() {
  return (
    <div className="relative flex min-h-screen flex-col justify-center items-center overflow-hidden">
      ...
      <ul className="my-6 ml-6 list-disc [&>li]:mt-2 text-sm max-w-2xl">
        ...
        <li>
          ...
          Degree (3 years) program can only apply for the Best Innovator Award.
        </li>
        <li>
        ...
        <li>
          Candidates can apply for a maximum of two (2) award categories. Please
          note that you cannot choose the same award for both selections.
        </li>
        <li>
          If you were a member of the JESA Organizing Committee in 2023 or 2024,
          you are eligible to apply for up to three (3) award categories.
        </li>
      </ul>
    </div>
  );
