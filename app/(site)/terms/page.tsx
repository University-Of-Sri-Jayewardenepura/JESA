	...
	return (
		<section className="mx-auto max-w-3xl px-6 py-[140px]">
			...
			<div>
				...
				<h3 className="mt-8 scroll-m-20 font-semibold text-2xl tracking-tight">
					Eligibility Criteria for BESA Inter University Award
				</h3>
				<ul className="my-6 ml-6 max-w-2xl list-disc text-md text-slate-400 [&>li]:mt-2">
					<li>
				...
				<ul className="my-6 ml-6 max-w-2xl list-disc text-md text-slate-400 [&>li]:mt-2">
					...
					<li>
						The innovation can be from any field and should be a completed one.
					</li>
					<li>
				...
				<ul className="my-6 ml-6 max-w-2xl list-disc text-md text-slate-400 [&>li]:mt-2">
					...
					<li>
						There should be completed outputs from any field mentioned in the
						award description. (graphic designing, art, photography, or any
				...
				<ul className="my-6 ml-6 max-w-2xl list-disc text-md text-slate-400 [&>li]:mt-2">
					...
					<li>
						Candidates should deliver and face the interviews in English medium.
					</li>
				</ul>
			</div>
