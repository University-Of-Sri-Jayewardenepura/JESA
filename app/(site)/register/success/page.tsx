...
const SuccessPageContent = () => {
	...
	const selectedAwards = awardsParam
		? awardsParam.split(",").filter(Boolean)
		: [];
	...
	const _formattedDate = currentDate.toLocaleString("en-US", {
		weekday: "long",
		month: "long",
		day: "numeric",
		year: "numeric",
					...
					<div className="mt-8 w-full max-w-md space-y-3">
						...
						{matchedLinks.map((link) => (
							...
							>
								<svg
									viewBox="0 0 24 24"
									className="w-5 h-5 shrink-0 fill-emerald-400"
									aria-hidden="true"
								>
