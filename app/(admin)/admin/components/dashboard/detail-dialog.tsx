				...
				<div className="space-y-6 text-sm">
					<Section title="Personal Information">
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
							<DetailItem
								label="Name"
								value={application.personalInfo?.publicDisplayName}
							/>
							...
							<DetailItem
								label="Mobile"
								value={application.personalInfo?.mobileNumber}
							/>
						</div>
					</Section>
					...
					<Section title="Academic Information">
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
							<DetailItem
								label="University"
								value={application.academicInfo?.university}
							/>
							<DetailItem
								label="Registration No"
								value={application.academicInfo?.universityRegistrationNumber}
							/>
							<DetailItem
								label="University Email"
								value={application.academicInfo?.universityEmail}
							/>
							<DetailItem
								label="Academic Year"
								value={application.academicInfo?.academicYear}
							/>
							<DetailItem
								label="Faculty"
								value={application.academicInfo?.faculty}
							/>
							<DetailItem
								label="Degree"
								value={application.academicInfo?.degree}
							/>
							<DetailItem
					...
					{application.awardSelection?.selectedAwards?.includes(
						"best-innovator",
					) &&
						application.bestInnovatorQuestions && (
					...
					{application.awardSelection?.selectedAwards?.includes("best-csr") &&
						application.bestCSRQuestions && (
							<Section title="Best CSR Details">
								<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
									<DetailItem
										label="Club Advisor"
										value={application.bestCSRQuestions.clubAdvisorNameTitle}
									/>
									<DetailItem
										label="Advisor Email"
										value={application.bestCSRQuestions.clubAdvisorEmail}
									/>
									<DetailItem
										label="Member Attending"
										value={application.bestCSRQuestions.memberAttendingName}
									/>
									<DetailItem
										label="Member WhatsApp"
										value={application.bestCSRQuestions.memberAttendingWhatsapp}
									/>
									<DetailItem
										label="Club President"
										value={application.bestCSRQuestions.clubPresidentName}
									/>
									<DetailItem
										label="President WhatsApp"
										value={application.bestCSRQuestions.clubPresidentWhatsapp}
									/>
									<DetailItem
										label="President Email"
										value={application.bestCSRQuestions.clubPresidentEmail}
									/>
								</div>
							</Section>
						)}
