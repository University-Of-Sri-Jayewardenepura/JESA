...
export enum AWARDS {
  ...
  BESA_INTER_UNIVERSITY = "BESA - Inter University Award",
  BESA_HUMANITIES_AND_SOCIAL_SCIENCES = "BESA - FHSS",
  BESA_APPLIED_SCIENCES = "BESA - FAS",
  BESA_MANAGEMENT_STUDIES_AND_COMMERCE = "BESA - FMSC",
  BESA_MEDICAL_SCIENCES = "BESA - FMS",
  BESA_TECHNOLOGY = "BESA - FOT",
  BESA_ENGINEERING = "BESA - FOE",
  BESA_ALLIED_HEALTH_SCIENCES = "BESA - FAHS",
  BESA_DENTAL_SCIENCES = "BESA - FDS", // Add this
  BESA_URBAN_AQUATIC = "BESA - FUAB", // Add this
}
