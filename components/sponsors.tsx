...
const sponsorTiers: SponsorTier[] = [
  {
    ...
    sponsors: [
      { name: "Celogen Lanka (Pvt) Ltd", logo: "/images/companies/celogen.png", available: false },
      { name: "Iconique (Pvt) Ltd", logo: "/images/companies/iconique.png", available: false },
    ],
  },
  {
    ...
    sponsors: [
      { name: "Hayleys PLC", logo: "/images/companies/hayleys.png", available: true },
    ],
  },
  {
    ...
    sponsors: [
      { name: "Aberdeen Holdings", logo: "/images/companies/aberdeen-holdings.png", available: true },
      { name: "Alpha Apparels Ltd", logo: "/images/companies/alpha-apparels.png", available: true },
      { name: "CIC Holdings PLC", logo: "/images/companies/cic.png", available: false },
      { name: "Brandix Apparel (Pvt) Ltd", logo: "/images/companies/brandix.png", available: true },
      { name: "Hemas Holdings PLC", logo: "/images/companies/hemas.png", available: false },
      { name: "Diesel & Motor Engineering PLC", logo: "/images/companies/dimo.png", available: true },
      { name: "Creative Software", logo: "/images/companies/creative-software.png", available: true },
      { name: "Mobitel (Pvt) Ltd", logo: "/images/companies/mobitel.png", available: true },
      { name: "John Keells Group", logo: "/images/companies/john-keells.png", available: false },
    ],
  },
  {
    title: "Gold Partners",
    ...
    sponsors: [
      { name: "Abans PLC", logo: "/images/companies/abans.png", available: false },
      { name: "Aberdeen Holdings", logo: "/images/companies/aberdeen-holdings.png", available: true },
    ],
  },
  {
    ...
    sponsors: [
      { name: "Aberdeen Holdings", logo: "/images/companies/aberdeen-holdings.png", available: true },
      { name: "Modern Pack Lanka (Pvt) Ltd", logo: "/images/companies/modern-pack.png", available: false },
      { name: "Alan Story (Pvt) Ltd", logo: "/images/companies/alan-story.png", available: true },
      { name: "Professional Outsourcing & Consulting (Pvt) Ltd", logo: "/images/companies/poc.png", available: false },
    ],
  },
];
