...
const ShinyButton = ({ text = "shiny-button" }) => {
  return (
    <motion.button
      {...animationProps}
      className="relative rounded-full px-6 py-2 font-medium backdrop-blur-xl transition-[box-shadow] duration-300 ease-in-out hover:shadow dark:bg-[radial-gradient(circle_at_50%_0%,#fbbf24_0%,transparent_60%)] dark:hover:shadow-[0_0_20px_#fbbf24]"
    >
      <span
        className="relative block h-full w-full text-sm uppercase tracking-wide text-[rgba(251,191,36,.9)]"
        style={{
          maskImage:
